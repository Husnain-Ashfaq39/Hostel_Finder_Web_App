                    ...
                    <div className="mt-6 sm:mx-auto sm:w-full sm:max-w-sm">
                        <form className="space-y-6" action="#" method="POST" onSubmit={handleSubmit(onSubmit)}>
                            <div className=' flex items-center justify-center'>
                                ...
                                <button onClick={() => navigate('/SignupHostelOwner')} className="font-semibold  text-indigo-600 hover:text-indigo-500 mt-1"> Sign Up</button>
                            </div>
                            <div>
                        ...
                        <div className=' flex space-x-4 p-6'>
                            ...
                            <button
                                className=" h-11 flex items-center bg-white border border-gray-300 rounded-lg shadow-md px-6 py-2 text-sm font-medium text-gray-800 hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
